namespace Repository.Migrations
{
    ...
    public partial class inicial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Ubigeo_IdUbigeo = c.String(maxLength: 255),
                    })
                .PrimaryKey(t => t.DocenteId)
                .ForeignKey("dbo.Curso", t => t.CursoId)
                .ForeignKey("dbo.Especialidad", t => t.EspecialidadId)
                .ForeignKey("dbo.Ubigeo", t => t.Ubigeo_IdUbigeo)
                .Index(t => t.EspecialidadId)
                .Index(t => t.CursoId)
                .Index(t => t.Ubigeo_IdUbigeo);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Docente", "Ubigeo_IdUbigeo", "dbo.Ubigeo");
            DropForeignKey("dbo.Apoderado", "Ubigeo_IdUbigeo", "dbo.Ubigeo");
            DropForeignKey("dbo.Matricula", "ApoderadoId", "dbo.Apoderado");
            DropForeignKey("dbo.Alumnos", "IdUbigeo", "dbo.Ubigeo");
            ...
            DropIndex("dbo.Apoderado", new[] { "Ubigeo_IdUbigeo" });
            DropIndex("dbo.Docente", new[] { "Ubigeo_IdUbigeo" });
            ...
            DropIndex("dbo.Alumnos", new[] { "IdUbigeo" });
